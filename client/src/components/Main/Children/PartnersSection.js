    ...
    return (
        <section className="container-fluid p-3 mt-3">
            ...
            <div className="row ">
                ...
                <div className="col text-center">
                    <img className="img-fluid" src="https://lh3.googleusercontent.com/pw/AMWts8BCjkrzMxD9k8oX98ZdTkB30u0-1UplzqZvUdEnnGUfb_5y__X94Ys_poxBxMGij6xMvSvl2VabVe76Jt0-K-O-TZSalRuTLo3Phs--r-PKcUsSpZFJetm7Ae0FsslrftQMvzGUw94f_bzuTvd-VCuf=w200-h151-no?authuser=0" alt="partner3" />
                </div>
            </div>
        </section>
    );
